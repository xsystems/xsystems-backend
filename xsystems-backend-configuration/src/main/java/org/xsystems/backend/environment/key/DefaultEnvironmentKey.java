...
package org.xsystems.backend.environment.key;

import org.xsystems.backend.environment.Environment;

public class DefaultEnvironmentKey implements EnvironmentKey {
  @Override
  public String getKey() {
    throw new IllegalStateException("The " + Environment.class.getSimpleName()
