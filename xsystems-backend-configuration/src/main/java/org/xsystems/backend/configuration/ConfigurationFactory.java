...
public class ConfigurationFactory {
  ...
  private static String DEFAULT_PROPERTIES_FILE = "/default.properties";
  ...
  String getValue(final Class<? extends ConfigurationKey> configurationKeyClass)
    ...
    final Constructor<? extends ConfigurationKey> configurationKeyConstructor =
        configurationKeyClass.getConstructor();
  ...
  /**
   * Maps a {@link Configuration} obtained from an {@link InjectionPoint} to a configuration
   * property.
   *
   * <p>The value corresponding to the configuration property is returned as {@link String}.</p>
   *
   * @param injectionPoint at which to inject the value corresponding to the configuration property
   *                       specified by a {@link Configuration} obtained form the
   *                       {@link InjectionPoint}.
   ...
   * property.
   *
   * <p>The value corresponding to the configuration property is returned as {@link Path}.</p>
   *
   * @param injectionPoint at which to inject the value corresponding to the configuration property
   *                       specified by a {@link Configuration} obtained form the
   *                       {@link InjectionPoint}.
