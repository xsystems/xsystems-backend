...
class EntityManagerFactory {
  ...
  /**
   * Produces an {@link EntityManager} that utilizes the given {@link DataSource}.
   *
   * @param dataSource to be utilized by the produced {@link EntityManager}.
   * @return an {@link EntityManager} that utilizes the given {@link DataSource}.
   */
  @Produces
  @ApplicationScoped
